...
class NewChit extends Component {
    ...
    addToDrafts =  async () => {
        if (this.state.newChitText) {
            ...
            // const activities = objectToSend;
            // activities.push(newActivity)
            // await AsyncStorage.setItem('draftChits', JSON.stringify(activities))


            //AsyncStorage.setItem("draftChits", JSON.stringify(objectToSend));
        } else {
            ...
            <View style={styles.container}>
                <View style={styles.form}>
                    ...
                    <View style={{marginBottom: 10, flexDirection: 'row', width: '100%'}}>
                        <View style={{flex: 1, flexDirection: 'column'}}>
                            <TouchableOpacity
                                ...
                                <Text style={styles.addPicText}> {loading ? "Loading..." : "Add Photo"} </Text>
                            </TouchableOpacity>
                        </View>
                        <View style={{flex: 1, flexDirection: 'column'}}>
                            <TouchableOpacity
                    ...
                    <View style={{marginBottom: 10, flexDirection: 'row', width: '100%'}}>
                        ...
                        {/*<Button color={'#303030'} title="Schedule a Chit" onPress={this.ShowHideTextComponentView} />*/}
                        {
                            this.state.status ?
                                <RNPickerSelect
